...
<span class="line"><span>pip install -e .[mineru]</span></span>
...
<span class="line"><span>dataflow pdf2model init</span></span>
<span class="line"><span></span></span>
<span class="line"><span>#训练</span></span>
<span class="line"><span>dataflow pdf2model train</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>pip install llamafactory[torch,metrics]</span></span>
<span class="line"><span>pip install open-dataflow[vllm]</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="第二步-创建新的dataflow工作文件夹" tabindex="-1"><a class="header-anchor" href="#第二步-创建新的dataflow工作文件夹"><span>第二步: 创建新的dataflow工作文件夹</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>#退出项目根目录</span></span>
<span class="line"><span>cd ..</span></span>
<span class="line"><span>mkdir run_dataflow</span></span>
<span class="line"><span>cd run_dataflow</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="第三步-设置数据集" tabindex="-1"><a class="header-anchor" href="#第三步-设置数据集"><span>第三步: 设置数据集</span></a></h2><p>将合适大小的数据集(数据文件为pdf格式)放到工作文件夹中</p><h2 id="第四步-初始化dataflow-pdf2model" tabindex="-1"><a class="header-anchor" href="#第四步-初始化dataflow-pdf2model"><span>第四步: 初始化dataflow-pdf2model</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>#初始化 </span></span>
<span class="line"><span>#--cache 可以指定.cache目录的位置（可选）</span></span>
<span class="line"><span>#默认值为当前文件夹目录</span></span>
<span class="line"><span>dataflow pdf2model init</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>初始化完成后，项目目录变成：</p><div class="language-shell line-numbers-mode" data-highlighter="shiki" data-ext="shell" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-shell"><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665;">项目根目录/</span></span>
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665;">├──</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D;"> Pdf2QAPipeline.py</span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD;">  # pipeline执行文件</span></span>
...
<span class="line"><span>dataflow pdf2model train</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>微调完成完成后，项目目录变成类似结构：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>项目根目录/</span></span>
<span class="line"><span>├── Pdf2QAPipeline.py  # pipeline执行文件</span></span>
...
<span class="line"><span>    │   └── pdf_list.jsonl</span></span>
<span class="line"><span>    ├── mineru/</span></span>
<span class="line"><span>    │   └── sample-1-7/auto/</span></span>
<span class="line"><span>    └── saves/</span></span>
<span class="line"><span>        └── pdf2model_cache_{timestamp}/</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="第六步-与微调好的模型对话" tabindex="-1"><a class="header-anchor" href="#第六步-与微调好的模型对话"><span>第六步: 与微调好的模型对话</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>#用法一:--model 可以指定 对话模型的路径位置（可选）</span></span>
<span class="line"><span>#默认值为.cache/saves/pdf2model_cache_{timestamp}</span></span>
<span class="line"><span>#用法二:到模型文件夹下 运行dataflow chat</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18)]))}const t=a(l,[["render",p]]),r=JSON.parse('{"path":"/zh/guide/i2pk9pwh/","title":"Pdf2ModelPipeline","lang":"zh-CN","frontmatter":{"title":"Pdf2ModelPipeline","createTime":"2025/08/30 14:27:02","permalink":"/zh/guide/i2pk9pwh/"},"readingTime":{"minutes":1.39,"words":417},"git":{"createdTime":1756536834000,"updatedTime":1756711927000,"contributors":[{"name":"Yalin-Feng","username":"Yalin-Feng","email":"Feng_Yalin@163.com","commits":2,"avatar":"https://avatars.githubusercontent.com/Yalin-Feng?v=4","url":"https://github.com/Yalin-Feng"},{"name":"Ma, Xiaochen","username":"","email":"mxch1122@126.com","commits":1,"avatar":"https://gravatar.com/avatar/c86bc98abf428aa442dfc12c76e70e324a551ebc637e5ed6634d60fbd3811221?d=retro"}]},"filePathRelative":"zh/notes/guide/pipelines/Pdf2ModelPipeline.md","headers":[]}');export{t as comp,r as data};
