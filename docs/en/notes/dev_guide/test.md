...
permalink: /en/dev_guide/test/
---

## Test

After developing a new pipeline or a single operator, test code should be provided under `DataFlow/test`, and corresponding test data should be provided under `DataFlow/dataflow/example`.

The test code’s implementation can refer to `DataFlow/test/test_reasoning.py`.
